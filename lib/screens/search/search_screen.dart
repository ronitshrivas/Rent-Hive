...
import 'package:renthive/screens/search/Trianglepainter.dart';
...
class _SearchScreenState extends State<SearchScreen>
  ...
  Widget _buildMapView(PropertyProvider propertyProvider) {
    return Consumer<LocationProvider>(
      builder: (context, locationProvider, child) {
        ...
        final userLat = locationProvider.currentLocation?.latitude ?? 27.7172;
        final userLng = locationProvider.currentLocation?.longitude ?? 85.3240;
                    ...
                    IconButton(
                      onPressed: () {
                        if (locationProvider.currentLocation != null) {
                          ...
                          // You'd need to pass MapController to do this
                        }
                      },
                      icon: const Icon(
  ...
  Widget _buildActiveFilters(PropertyProvider propertyProvider) {
    ...
    if (propertyProvider.minPrice != null ||
        propertyProvider.maxPrice != null) {
      String priceText = '';
      if (propertyProvider.minPrice != null &&
          propertyProvider.maxPrice != null) {
        priceText =
            '₹${propertyProvider.minPrice!.toInt()}-${propertyProvider.maxPrice!.toInt()}';
    ...
    if (propertyProvider.location != null &&
        propertyProvider.location!.isNotEmpty) {
      filterChips.add(
        _buildFilterChip(
  ...
  bool _hasActiveFilters(PropertyProvider propertyProvider) {
    return propertyProvider.selectedPropertyType != null ||
        ...
        propertyProvider.maxPrice != null ||
        (propertyProvider.location != null &&
            propertyProvider.location!.isNotEmpty) ||
