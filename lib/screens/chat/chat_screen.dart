...
class _ChatScreenState extends State<ChatScreen> {
  ...
  UserModel? _otherUser; // Add this
  bool _isLoadingUser = true; // A

  @override
  void initState() {
    super.initState();
    _loadOtherUser(); // Add this
  ...
  Future<void> _loadOtherUser() async {
    try {
      final user = await FirebaseService().getUserById(widget.otherUserId);
      setState(() {
        _otherUser = user;
                        ...
                        return Column(
                          children: [
                            ...
                            MessageBubble(
                              ...
                              otherUser: _otherUser, // Pass user data
                            ),
                          ],
                        );
                      },
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Online', // You can make this dynamic with presence system
                          style: TextStyle(
                            fontSize: 12,
...
class MessageBubble extends StatelessWidget {
  ...
  final UserModel? otherUser; // Add this
        ...
        children: [
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    isMe ? AppColors.primaryColor : AppColors.backgroundColor,
                borderRadius: BorderRadius.only(
