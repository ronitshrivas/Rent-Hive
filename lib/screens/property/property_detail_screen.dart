...
import 'package:renthive/screens/location/full_map_screen.dart';
...
class _PropertyDetailScreenState extends State<PropertyDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        final bool isFavorite = authProvider.isFavoriteProperty(
          widget.property.id,
        );
        ...
        return Scaffold(
          body: CustomScrollView(
            ...
            slivers: [
              ...
              // Property Details
              SliverToBoxAdapter(child: _buildPropertyDetails()),
            ],
          ),
  ...
  Widget _buildPropertyDetailsSection() {
    return Column(
      ...
      children: [
        ...
        _buildDetailRow(
          'Property Type',
          widget.property.propertyType.displayName,
        ),
        _buildDetailRow(
          'Furnishing',
          widget.property.details.furnishing.displayName,
        ),
        _buildDetailRow(
          'Floor',
          '${widget.property.details.floor} of ${widget.property.details.totalFloors}',
        ),
        ...
        if (widget.property.details.securityDeposit != null)
          _buildDetailRow(
            'Security Deposit',
            widget.property.details.securityDeposit!,
          ),
        if (widget.property.details.maintenanceCharges != null)
          _buildDetailRow(
            'Maintenance',
            widget.property.details.maintenanceCharges!,
          ),
      ],
    );
  }
                  ...
                  if (locationProvider.currentLocation != null) ...[
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 2),
                              Text(
                                _calculateDistance(locationProvider),
                                style: const TextStyle(
                                  fontSize: 14,
                        ...
                        const SizedBox(width: 4),
                        Text(
                          _estimateWalkingTime(locationProvider),
                          style: const TextStyle(
                            fontSize: 12,
                            color: AppColors.textSecondary,
                          ),
  ...
  void _openFullMap(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                FullMapScreen(property: widget.property, showNavigation: true),
      ),
    );
  }

  String _calculateDistance(LocationProvider locationProvider) {
    if (locationProvider.currentLocation == null) {
      return 'Unknown';
    }
    ...
    return locationProvider.formatDistance(distance);
  }

  String _estimateWalkingTime(LocationProvider locationProvider) {
    if (locationProvider.currentLocation == null) {
      return '';
    }
  ...
  void _shareLocation() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Location URL: $googleMapsUrl'),
          ...
          children: [
            ...
            Expanded(
              child: CustomOutlinedButton(
                ...
                onPressed:
                    () => _makePhoneCall(widget.property.contactInfo.phone),
  ...
  void _toggleFavorite(AuthProvider authProvider) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor:
            isFavorite ? AppColors.errorColor : AppColors.successColor,
  ...
  void _openVirtualTour() {
    if (widget.property.virtualTourImages.isNotEmpty ||
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => VirtualTourScreen(property: widget.property),
        ),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('No images available for this property')),
      );
    }
  }
  ...
  Future<void> _sendEmail(String email) async {
    final Uri emailUri = Uri(
      scheme: 'mailto',
      path: email,
      queryParameters: {'subject': 'Inquiry about ${widget.property.title}'},
    );
...
class VirtualTourScreen extends StatefulWidget {
  ...
  const VirtualTourScreen({super.key, required this.property});
