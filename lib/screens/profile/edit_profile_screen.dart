            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildImageOption('Camera', Icons.camera_alt_rounded, () {
                    ...
                    _buildImageOption('Remove', Icons.delete_rounded, () {
                      Navigator.pop(context);
                      setState(() {
                        _selectedImage = null;
                      });
  ...
  Future<void> _saveProfile(AuthProvider authProvider) async {
    ...
    if (_selectedImage != null) {
      ...
      if (authProvider.user?.profileImage != null) {
        await FirebaseService().deleteProfileImage(
    ...
    final success = await authProvider.updateProfile(
      ...
      profileImage: profileImageUrl ?? authProvider.user?.profileImage,
    );
